  ...
  return (
    <>
      ...
      >
        <path
          style={{ fill: "#9BFCFF" }}
          d="M1.398,431.634l21.593-89.001c3.063-12.622,11.283-23.562,22.554-30.015l83.684-47.915
      ...
      C30.933,502.312-7.892,469.921,1.398,431.634z"
        ...
        <path
          style={{ fill: "#83C9FF" }}
          d="M483.927,212.665L256.011,110.541v290.923L483.929,299.34
      C521.334,282.578,521.383,229.446,483.927,212.665z"
        />
        <path
          style={{ fill: "#2586FD" }}
          d="M186.997,329.76c-4.231-9.44-0.006-20.523,9.434-24.752l109.37-49.006l-109.37-49.006
      ...
      l-147.519,66.1C202.311,343.423,191.229,339.205,186.997,329.76z"
        ...
        <path
          style={{ fill: "#3A4DE2" }}
          d="M359.268,238.908L256.01,192.64v41.05l49.791,22.311l-49.791,22.311v41.05l103.258-46.268
